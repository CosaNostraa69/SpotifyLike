...
export default async function Home() {
  ...
  <p className="text-gray-300 mt-2">Ceci est la section de contenu principal.</p>
  <div className="grid grid-cols-5 gap-4 mt-8">
    {albums &&
      albums.albums.items.map((album) => (
        <div key={album.id} className="bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
          <Image 
  ...
  <div className="mt-8">
    <Link
      className="inline-block bg-gray-700 text-white px-8 py-2 rounded-lg shadow-md hover:bg-gray-600 transition-colors duration-300"
      href="/all-albums"
    >
